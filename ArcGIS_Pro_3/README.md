...
Output:
- mosaic_extent.shp  
- Final shapefile stored in the folder: 👉 [**`Final Extent Shapefile/`**](https://github.com/IssaNasralli/TriFusionBD/tree/main/ArcGIS_Pro_3/Final%20Extent%20Shapefile)
